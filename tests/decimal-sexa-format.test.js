...
describe('parse', () => {
    ...
    it("returns the correct latitude and longitude for '1.23412312° 5.6782356°' with precision 4", () => {
        const df = new DecimalSexaFormat({ precision: 4 });
