...
import { DmsSignedSuffixedHemisphereFormat } from '../src/formats/dms-signed-suffixed-hemisphere-format.ts';
...
describe('parse', () => {
    ...
    it(`returns the correct latitude and longitude for N 40° 7' 23.9999" N, 74° 7' 23.9999" W"`, () => {
